# Linux-Server-Perfomance-stats-script
A simple bash script to analayze your server's perfomance.
This script analayzes the total disk space available in your system plus total inodes available on your system.It also checks the system top 5 processes which are using the highest amount of cpu and memory(RAM).
